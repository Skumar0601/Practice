	...
	public class ProductService implements IProductService {	
	   ...
	   @Override
		...
		@Override
		public Optional<Product> getProductByName(String pname) throws ResourceNotFoundException {
			logger.info("Fetching product with name: " + pname);
			Optional<Product> product = productRepo.findByPname(pname);
			
			// If product is not found, throw a ResourceNotFoundException
			if (!product.isPresent()) {
				throw new ResourceNotFoundException("Product not found with name: " + pname);
			}
